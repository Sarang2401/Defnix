        ...
        <div className="pt-32 pb-20">
            ...
            <section className="max-w-4xl mx-auto px-6 mb-24">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.5 }}
                    className="rounded-xl bg-neutral-900 border border-white/10 p-8 lg:p-12"
                >
            ...
            <section className="max-w-4xl mx-auto px-6">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.5 }}
                    className="rounded-xl bg-neutral-900 border border-white/10 p-10 lg:p-14 text-center"
                >
